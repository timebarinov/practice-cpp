...
void ProcessSearches(istream& query_input, ostream& search_results_output, Synchronized<InvertedIndex>& index_handle) {
...
void SearchServer::AddQueriesStream(istream& query_input, ostream& search_results_output) {
    async_tasks.push_back(
        async( ProcessSearches, ref(query_input), ref(search_results_output), ref(index)));
}